module Savi::Program::Declarator::Bootstrap
  ...
  BOOTSTRAP_DECLARATORS = [
    ...
    Declarator.new_bootstrap("collect_into",
      intrinsic: true,
      context: "declarator",
      begins: ["declarator_collect_into"],
      # collect_into: "Savi.Declared.Declarators.Collect",
      terms: [
        TermAcceptor::Typed.new(Source::Pos.none, "kind", "Name"),
      ] of TermAcceptor,
    ),
    Declarator.new_bootstrap("with_tag",
      intrinsic: true,
      context: "declarator_collect_into",
      # collect_into: "Savi.Declared.Declarators.Tags",
      terms: [
        TermAcceptor::Typed.new(Source::Pos.none, "tag", "Name"),
      ] of TermAcceptor,
    ),
    Declarator.new_bootstrap("apply_tag",
      intrinsic: true,
      context: "declarator",
      # collect_into: "Savi.Declared.Declarators.Tags",
      terms: [
    ...
    Declarator.new_bootstrap("apply_attr",
      intrinsic: true,
      context: "declarator",
      begins: ["declarator_apply_attr"],
      # collect_into: "Savi.Declared.Declarators.Attrs",
      terms: [
        TermAcceptor::Typed.new(Source::Pos.none, "attr", "Name"),
      ] of TermAcceptor,
    ),
    Declarator.new_bootstrap("from_term",
      intrinsic: true,
      context: "declarator_apply_attr",
      apply_attr: ("from_term", "term"),
      terms: [
        TermAcceptor::Typed.new(Source::Pos.none, "term", "Name"),
      ] of TermAcceptor,
    ),
  ]
end
