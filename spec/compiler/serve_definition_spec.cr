describe Mare::Compiler::ServeDefinition do
  ...
  it "can find local variable declaration" do
    ...
    pos = ctx.serve_definition[Mare::Source::Pos.point(source, 5, 15)].not_nil!
    pos.row.should eq 3
    pos.col.should eq 4
    pos.size.should eq "example1".bytesize

    pos = ctx.serve_definition[Mare::Source::Pos.point(source, 5, 8)].not_nil!
    pos.row.should eq 5
    pos.col.should eq 4
  ...
  it "can find method declaration" do
    ...
    pos = ctx.serve_definition[Mare::Source::Pos.point(source, 10, 18)].not_nil!
    pos.row.should eq 3
    pos.col.should eq 7
    pos.size.should eq "new_iso".bytesize

    pos = ctx.serve_definition[Mare::Source::Pos.point(source, 11, 25)].not_nil!
    pos.row.should eq 5
    pos.col.should eq 7
